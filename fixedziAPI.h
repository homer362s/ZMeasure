...
// This was removed as CVI dosent provide it
...
DEPRECATED_ENUM(static const ZIResult_enum ZI_SUCCESS         = ZIResult_enum_cast(0x0000));
DEPRECATED_ENUM(static const ZIResult_enum ZI_MAX_INFO        = ZIResult_enum_cast(0x0001));
DEPRECATED_ENUM(static const ZIResult_enum ZI_WARNING         = ZIResult_enum_cast(0x4000));
DEPRECATED_ENUM(static const ZIResult_enum ZI_UNDERRUN        = ZIResult_enum_cast(0x4001));
DEPRECATED_ENUM(static const ZIResult_enum ZI_OVERFLOW        = ZIResult_enum_cast(0x4002));
DEPRECATED_ENUM(static const ZIResult_enum ZI_NOTFOUND        = ZIResult_enum_cast(0x4003));
DEPRECATED_ENUM(static const ZIResult_enum ZI_MAX_WARNING     = ZIResult_enum_cast(0x4004));
DEPRECATED_ENUM(static const ZIResult_enum ZI_ERROR           = ZIResult_enum_cast(0x8000));
DEPRECATED_ENUM(static const ZIResult_enum ZI_USB             = ZIResult_enum_cast(0x8001));
DEPRECATED_ENUM(static const ZIResult_enum ZI_MALLOC          = ZIResult_enum_cast(0x8002));
DEPRECATED_ENUM(static const ZIResult_enum ZI_MUTEX_INIT      = ZIResult_enum_cast(0x8003));
DEPRECATED_ENUM(static const ZIResult_enum ZI_MUTEX_DESTROY   = ZIResult_enum_cast(0x8004));
DEPRECATED_ENUM(static const ZIResult_enum ZI_MUTEX_LOCK      = ZIResult_enum_cast(0x8005));
DEPRECATED_ENUM(static const ZIResult_enum ZI_MUTEX_UNLOCK    = ZIResult_enum_cast(0x8006));
DEPRECATED_ENUM(static const ZIResult_enum ZI_THREAD_START    = ZIResult_enum_cast(0x8007));
DEPRECATED_ENUM(static const ZIResult_enum ZI_THREAD_JOIN     = ZIResult_enum_cast(0x8008));
DEPRECATED_ENUM(static const ZIResult_enum ZI_SOCKET_INIT     = ZIResult_enum_cast(0x8009));
DEPRECATED_ENUM(static const ZIResult_enum ZI_SOCKET_CONNECT  = ZIResult_enum_cast(0x800a));
DEPRECATED_ENUM(static const ZIResult_enum ZI_HOSTNAME        = ZIResult_enum_cast(0x800b));
DEPRECATED_ENUM(static const ZIResult_enum ZI_CONNECTION      = ZIResult_enum_cast(0x800c));
DEPRECATED_ENUM(static const ZIResult_enum ZI_TIMEOUT         = ZIResult_enum_cast(0x800d));
DEPRECATED_ENUM(static const ZIResult_enum ZI_COMMAND         = ZIResult_enum_cast(0x800e));
DEPRECATED_ENUM(static const ZIResult_enum ZI_SERVER_INTERNAL = ZIResult_enum_cast(0x800f));
DEPRECATED_ENUM(static const ZIResult_enum ZI_LENGTH          = ZIResult_enum_cast(0x8010));
DEPRECATED_ENUM(static const ZIResult_enum ZI_FILE            = ZIResult_enum_cast(0x8011));
DEPRECATED_ENUM(static const ZIResult_enum ZI_DUPLICATE       = ZIResult_enum_cast(0x8012));
DEPRECATED_ENUM(static const ZIResult_enum ZI_READONLY        = ZIResult_enum_cast(0x8013));
DEPRECATED_ENUM(static const ZIResult_enum ZI_MAX_ERROR       = ZIResult_enum_cast(0x8014));
#endif
...
DEPRECATED_ENUM(static const ZIValueType_enum ZI_DATA_NONE         = ZIValueType_enum_cast(0));
DEPRECATED_ENUM(static const ZIValueType_enum ZI_DATA_DOUBLE       = ZIValueType_enum_cast(1));
DEPRECATED_ENUM(static const ZIValueType_enum ZI_DATA_INTEGER      = ZIValueType_enum_cast(2));
DEPRECATED_ENUM(static const ZIValueType_enum ZI_DATA_DEMODSAMPLE  = ZIValueType_enum_cast(3));
DEPRECATED_ENUM(static const ZIValueType_enum ZI_DATA_SCOPEWAVE    = ZIValueType_enum_cast(4));
DEPRECATED_ENUM(static const ZIValueType_enum ZI_DATA_AUXINSAMPLE  = ZIValueType_enum_cast(5));
DEPRECATED_ENUM(static const ZIValueType_enum ZI_DATA_DIOSAMPLE    = ZIValueType_enum_cast(6));
DEPRECATED_ENUM(static const ZIValueType_enum ZI_DATA_BYTEARRAY    = ZIValueType_enum_cast(7));
DEPRECATED_ENUM(static const ZIValueType_enum ZI_DATA_TREE_CHANGED = ZIValueType_enum_cast(16));
#endif
...
DEPRECATED_ENUM(static const ZIListNodes_enum ZI_LIST_NONE           = ZIListNodes_enum_cast(0x00));
DEPRECATED_ENUM(static const ZIListNodes_enum ZI_LIST_RECURSIVE      = ZIListNodes_enum_cast(0x01));
DEPRECATED_ENUM(static const ZIListNodes_enum ZI_LIST_ABSOLUTE       = ZIListNodes_enum_cast(0x02));
DEPRECATED_ENUM(static const ZIListNodes_enum ZI_LIST_LEAFSONLY      = ZIListNodes_enum_cast(0x04));
DEPRECATED_ENUM(static const ZIListNodes_enum ZI_LIST_SETTINGSONLY   = ZIListNodes_enum_cast(0x08));
#endif
...
DEPRECATED_ENUM(static const TREE_ACTION TREE_ACTION_REMOVE   = TREE_ACTION_cast(0));
DEPRECATED_ENUM(static const TREE_ACTION TREE_ACTION_ADD      = TREE_ACTION_cast(1));
DEPRECATED_ENUM(static const TREE_ACTION TREE_ACTION_CHANGE   = TREE_ACTION_cast(2));
#endif
